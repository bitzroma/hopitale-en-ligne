 ...
 */
final class Version20210108012311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D64991EF7EAA ON user');
        $this->addSql('ALTER TABLE user DROP rendez_vous_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD rendez_vous_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64991EF7EAA FOREIGN KEY (rendez_vous_id) REFERENCES rendez_vous (id)');
        $this->addSql('CREATE INDEX IDX_8D93D64991EF7EAA ON user (rendez_vous_id)');
    }
}
